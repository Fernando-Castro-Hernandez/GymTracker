...
namespace GymTracker.Migrations
{
    ...
    [Migration("20260718184816_AgregarChatMensajes")]
    partial class AgregarChatMensajes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GymTracker.Models.ChatMensaje", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("GymTracker.Models.Ejercicio", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("GymTracker.Models.Medicion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<decimal?>("PorcentajeAgua")
                        .HasPrecision(6, 2)
                        .HasColumnType("numeric(6,2)");
            ...
            modelBuilder.Entity("GymTracker.Models.Rutina", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("GymTracker.Models.RutinaEjercicio", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("GymTracker.Models.SerieRealizada", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("RepeticionesReales")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("GymTracker.Models.Sesion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("GymTracker.Models.RutinaEjercicio", b =>
                {
                    b.HasOne("GymTracker.Models.Ejercicio", "Ejercicio")
                        .WithMany()
                        .HasForeignKey("EjercicioId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("GymTracker.Models.Rutina", "Rutina")
                        .WithMany("Ejercicios")
            ...
            modelBuilder.Entity("GymTracker.Models.SerieRealizada", b =>
                {
                    b.HasOne("GymTracker.Models.Sesion", "Sesion")
                        .WithMany("Series")
